...
namespace rc019415MIS4200.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "classesId,title,description")] Classes classes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "classesId,title,description")] Classes classes)
        {
            if (ModelState.IsValid)
            {
